  ...
  <view class="center" :style="{'padding-top': statusBarHeight + 'px'}">
      ...
      <view class="vip">
        ...
        <view class="vip-bg" v-else>
          ...
          <template v-else>
            <span class="vip-bg-l"></span>
            <span
                style="color: rgb(235, 209, 182);font-size: 12px">到期时间:{{
                $u.timeFormat(userInfo.vip.expiration, 'yyyy-mm-dd hh:MM:ss')
              }}</span>
    ...
    <view class="my-wallet">
      ...
      <view class="wallet" @click="goWallet">
        <view class="wallet-l">
          ...
          <span class="balance">余额:{{ userInfo.balance || 0 }}</span>
        </view>
    ...
    <view class="bottom-list">
      ...
      <view class="tools">
        ...
        <view class="feedback part" @click="goFeedback">
...
<!--    <u-modal :show="show" :closeOnClickOverlay="true" confirmText="去登录" cancelText="取消" :showCancelButton="true">-->
<!--      你还没有登录哦～，登录后开通VIP-->
<!--    </u-modal>-->
  </view>
</template>
