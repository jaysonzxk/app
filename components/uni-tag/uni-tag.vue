<template>
	<view class="uni-tag" v-if="text" :class="[disabled === true || disabled === 'true' ? 'uni-order--disabled' : '',inverted === true || inverted === 'true' ? 'uni-order--inverted' : '',circle === true || circle === 'true' ? 'uni-order--circle' : '','uni-order--'+size,'uni-order--'+type]"
